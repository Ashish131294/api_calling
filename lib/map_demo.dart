...
class map_demo extends StatefulWidget {
  const map_demo({Key? key}) : super(key: key);

  @override
  State<map_demo> createState() => _map_demoState();
}

class _map_demoState extends State<map_demo> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Text("Map API Calling"), centerTitle: true),
        body: status ? ListView.builder(itemCount:m!.users!.length,itemBuilder: (context, index) {
          return Card(child: ListTile(
            leading: Text("${m!.users![index].id}"),
            title: Text("${m!.users![index].firstName} \t ${m!.users![index].lastName}"),
...
class demo {
  ...
  demo({this.users, this.total, this.skip, this.limit});
